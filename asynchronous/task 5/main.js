...
function processData2(data) {
    return new Promise(function (reject) {
        reject("Process Data: ".concat(data));
    });
}
;
function executeSequentially() {
    return __awaiter(this, void 0, void 0, function () {
        var fetchDataResult, processDataResult, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetchData1()];
                case 1:
                    fetchDataResult = _b.sent();
                    console.log(fetchDataResult);
                    return [4 /*yield*/, processData2(fetchDataResult)];
                case 2:
                    processDataResult = _b.sent();
